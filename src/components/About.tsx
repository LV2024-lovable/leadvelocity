      ...
      <div className="container max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Our team of experts combines data-driven insights with creative strategies to create marketing campaigns that deliver measurable results. We work closely with you to understand your unique challenges and goals, developing customized solutions that align with your business objectives.
            </p>
